...
'>': '>',
'>=': '>=',
'@markmin\x01An error occured, please [[reload %s]] the page': 'Ocurrió un error, por favor [[reload %s]] la página',
...
'Cliente': 'Cliente',
'Clientes': 'Clientes',
'Clientes(created_by)': 'Clientes(created_by)',
'Clientes(modified_by)': 'Clientes(modified_by)',
'Close': 'Cerrar',
'Cod Year Month': 'Cod Year Month',
'Codsearch': 'Codsearch',
'Community': 'Comunidad',
'compile': 'compilar',
...
'Concepto': 'Concepto',
'Concepto prestamos': 'Concepto prestamos',
'Concepto prestamos(created_by)': 'Concepto prestamos(created_by)',
'Concepto prestamos(modified_by)': 'Concepto prestamos(modified_by)',
'contains': 'contains',
...
'Cuotas': 'Cuotas',
'Cuotas(created_by)': 'Cuotas(created_by)',
'Cuotas(modified_by)': 'Cuotas(modified_by)',
...
'errors': 'errores',
'Errors': 'Errores',
'Errors in form, please check it out.': 'Error en el formulario, por favor controle',
...
'Importe ($)': 'Importe ($)',
'Importe Financiado ($)': 'Importe Financiado ($)',
'in': 'in',
'includes': 'incluye',
'Index': 'Índice',
'Ingrese una fecha': 'Ingrese una fecha',
...
'Invalid login': 'Usuario o contraseña no válidos',
...
'Password': 'Contraseña',
"Password fields don't match": 'Los campos contraseñas no coinciden',
'Peeking at file': 'Visualizando archivo',
'please input your password again': 'por favor ingresa tu contraseña nuevamente',
'Plugins': 'Plugins',
'Powered by': 'Este sitio usa',
'Prestamo Id': 'Prestamo Id',
'Prestamos': 'Prestamos',
'Prestamos(created_by)': 'Prestamos(created_by)',
'Prestamos(modified_by)': 'Prestamos(modified_by)',
...
'Registration successful': 'Registración satisfactoria',
...
'This email already has an account': 'Este correo ya existe en una cuenta',
...
'Verify Password': 'Controle su contraseña',
